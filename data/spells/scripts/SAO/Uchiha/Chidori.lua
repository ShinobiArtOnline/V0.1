...
function onCastSpell(cid, var)
	...
	local mdmg = - math.max(1, math.ceil(((skill_factor*0.4) * jutsuDmg)*0.55))
		...
		addEvent(doSendMagicEffect, 30, {x = pos.x+1, y = pos.y, z = pos.z}, 29)
	elseif getCreatureLookDir(cid) == 1 then
		addEvent(doSendMagicEffect, 30, {x = pos.x+2, y = pos.y+1, z = pos.z}, 29)
	elseif getCreatureLookDir(cid) == 2 then
		addEvent(doSendMagicEffect, 30, {x = pos.x+1, y = pos.y+2, z = pos.z}, 29)
	elseif getCreatureLookDir(cid) == 3 then
		addEvent(doSendMagicEffect, 60, {x = pos.x, y = pos.y+1, z = pos.z}, 29)
	end
