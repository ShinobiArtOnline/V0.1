...
STORAGE_KAGEMANE_TARGETS_END = 9060 -- botei até 50 targets
...
kagePos.x = getPlayerStorageValue(cid, STORAGE_KAGEMANELASTPOS_X)
  ...
  local pos = getPositionByDir(kagePos, dir)
          ...
          -- sombra principal --
             local sombra = doCreateItem2(11475, 1, pos)
             if(sombra) then
          ...
          -- lateral 1 --
             ...
             local sombra = doCreateItem2(11473, 1, npos1)
             if(sombra) then
          ...
          elseif dir == 1 then
             local sombra = doCreateItem(11473, 1, pos)
             if(sombra) then
             doItemSetAttribute(sombra, "name","a shadow. It belongs to "..playername)
             doItemSetAttribute(sombra, "aid", 2000)
             table.insert(shadows_db, {pos.x,pos.y,pos.z})
          ...
          -- lateral 1 --
             ...
             local sombra = doCreateItem(11475, 1, npos1)
             if(sombra) then
             table.insert(shadows_db,{npos1.x,npos1.y,npos1.z})
             doItemSetAttribute(sombra, "name","a shadow. It belongs to "..playername)
             doItemSetAttribute(sombra, "aid", 2000)
          ...
          elseif dir == 2 then
             ...
             local sombra = doCreateItem2(11479, 1, pos)
             if(sombra) then
             doItemSetAttribute(sombra, "name","a shadow. It belongs to "..playername)
             doItemSetAttribute(sombra, "aid", 2000)
             table.insert(shadows_db,{pos.x,pos.y,pos.z})
          ...
          -- lateral 1 --
             npos1 = getPositionByDir(pos, 1)
             local sombra = doCreateItem2(11477, 1, npos1)
             if(sombra) then
             table.insert(shadows_db, {npos1.x,npos1.y,npos1.z})
             doItemSetAttribute(sombra, "name","a shadow. It belongs to "..playername)
             doItemSetAttribute(sombra, "aid", 2000)
...
function createKagemaneTriplicate(cid)
  ...
  createKagemaneDuplicate(cid)
            if dir == 0 then        
             local sombra = doCreateItem2(11473, 1, pos)
             if(sombra) then
             table.insert(shadows_db, {pos.x,pos.y,pos.z})
             doItemSetAttribute(sombra, "name","a shadow. It belongs to "..playername)
          ...
          -- lateral 2 --
             ...
             local sombra = doCreateItem2(11473, 1, npos2)
             if(sombra) then
          ...
          -- lateral 1 --
             npos1 = getPositionByDir(pos, 0)
             local sombra = doCreateItem2(11475, 1, npos1)
             if(sombra) then
             table.insert(shadows_db,{npos1.x,npos1.y,npos1.z})
             doItemSetAttribute(sombra, "name","a shadow. It belongs to "..playername)
             doItemSetAttribute(sombra, "aid", 3000)
          ...
          -- lateral 2 --
             ...
             local sombra = doCreateItem2(11479, 1, npos2)
             if(sombra) then
             table.insert(shadows_db,{npos2.x,npos2.y,npos2.z})
             doItemSetAttribute(sombra, "name","a shadow. It belongs to "..playername)
             doItemSetAttribute(sombra, "aid", 3000)
          ...
          elseif dir == 2 then
              ...
              -- sombra principal --
             local sombra = doCreateItem2(11474, 1, pos)
             if(sombra) then
             doItemSetAttribute(sombra, "name","a shadow. It belongs to "..playername)
             doItemSetAttribute(sombra, "aid", 3000)
             table.insert(shadows_db,{pos.x,pos.y,pos.z})
          ...
          -- lateral 1 --
             npos1 = getPositionByDir(pos, 1)
             local sombra = doCreateItem2(11474, 1, npos1)
             if(sombra) then
             table.insert(shadows_db, {npos1.x,npos1.y,npos1.z})
             doItemSetAttribute(sombra, "name","a shadow. It belongs to "..playername)
             doItemSetAttribute(sombra, "aid", 3000)
          ...
          -- lateral 2 --
             npos2 = getPositionByDir(pos, 3)
             local sombra = doCreateItem2(11478, 1, npos2)
             if(sombra) then
             table.insert(shadows_db,{npos2.x,npos2.y,npos2.z})
             doItemSetAttribute(sombra, "name","a shadow. It belongs to "..playername)
             doItemSetAttribute(sombra, "aid", 3000)
          ...
          -- lateral 2 --
             npos2 = getPositionByDir(pos, 2)
             local sombra = doCreateItem2(11480, 1, npos2)
             if(sombra) then
             table.insert(shadows_db, {npos2.x,npos2.y,npos2.z})
             doItemSetAttribute(sombra, "name","a shadow. It belongs to "..playername)
             doItemSetAttribute(sombra, "aid", 3000)
