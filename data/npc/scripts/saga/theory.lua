...
function onCreatureSay(cid, type, msg)
	...
	if((msg == "hi") and not (isFocused(cid))) then
		selfSay("Ok, ".. getCreatureName(cid) ..". I have a One question, but if you dont answer it you will never be a chunin! So, do you wanna {answer} or {pass}?.", cid)
		addFocus(cid)

	elseif (isFocused(cid) and msg == "answer" and getPlayerStorageValue(cid,8000) <= 7) then
		selfSay("Sorry, but you can\'t do this {saga} now", cid)
		
	elseif (isFocused(cid) and msg == "answer" and getPlayerStorageValue(cid,8000) >= 9) then
		selfSay("Sorry, but you can\'t do this {saga} any more.", cid)

	elseif (isFocused(cid) and msg == "answer") then
		
		
		setPlayerStorageValue(cid,8000,9)
		selfSay("Well, ".. getCreatureName(cid) ..". You are Pass! That was a question of theory exam, a shinobi choose is very dificualt .", cid)
