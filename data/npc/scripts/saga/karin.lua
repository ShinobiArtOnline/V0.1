...
function onCreatureSay(cid, type, msg)
	...
	if((msg == "hi") and not (isFocused(cid))) then
		selfSay("Yes, I will {go} where you want.", cid)
		addFocus(cid)
	...
	elseif (isFocused(cid) and msg == "go" and getPlayerStorageValue(cid,8000) >= 47) then
		selfSay("Sorry, but you can\'t do this {saga} any more.", cid)

	elseif (isFocused(cid) and msg == "go") then
		
		
		setPlayerStorageValue(cid,8000,47)
		selfSay("Juugo is in the minus floor.", cid)
