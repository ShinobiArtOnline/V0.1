...
function onCreatureSay(cid, type, msg)
	...
	if((msg == "hi") and not (isFocused(cid))) then
		selfSay("Ok you mast {loss} your opponent", cid)
		addFocus(cid)

	elseif (isFocused(cid) and msg == "loss" and getPlayerStorageValue(cid,8000) <= 10) then
	...
	elseif (isFocused(cid) and msg == "loss") then
		...
		selfSay("Your Opponent is Kiba!.", cid)
