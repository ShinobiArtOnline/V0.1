...
addOutfitCondition(conditionBlack, {lookType = 317, lookHead = 114, lookBody = 114, lookLegs = 114, lookFeet = 114})
local conditionRed = createConditionObject(CONDITION_OUTFIT)
setConditionParam(conditionRed, CONDITION_PARAM_TICKS, -1)
addOutfitCondition(conditionRed, {lookType = 761, lookHead = 94, lookBody = 94, lookLegs = 94, lookFeet = 94})
